...
class AStarGatePathGenerator:
    ...
    def plan_segment(self, grid, start, goal, preferred_velocity=None):
...
class RRTStarGatePathGenerator(AStarGatePathGenerator):
    ...
    def plan_segment(self, grid, start, goal, preferred_velocity=None):
        ...
        if path is None:
            print(
                "WARNING: RRT* failed; falling back to A* segment:",
                "start=", start,
                "goal=", goal,
            )
...
class DStarLiteGatePathGenerator(AStarGatePathGenerator):
    ...
    def _segment_search_bounds(self, grid, start_idx, goal_idx):
