"""Motion-aware timing for the native MPPI reference stack."""
...
class MotionAwareTiming:
    ...
    def __init__(
        ...
        """Configure the cruise speed and the turn/vertical time-penalty gains."""
    ...
    def compute(
        ...
        """Return per-waypoint timestamps, slowing for sharp turns and vertical motion."""
        ...
        vertical_multiplier = 1.0 + self.vertical_time_gain * np.power(
            vertical_ratio, self.vertical_ratio_power
        )
