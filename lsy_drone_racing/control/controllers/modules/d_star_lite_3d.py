...
from lsy_drone_racing.control.controllers.challenge.modules.astar_3d import (
    NEIGHBOR_STEPS_18,
    heuristic,
)
...
def calculate_key(
    idx: GridIdx, start_idx: GridIdx, g: np.ndarray, rhs: np.ndarray, heuristic_weight: float
) -> tuple[float, float]:
